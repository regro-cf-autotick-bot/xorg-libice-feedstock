...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xorg-libice-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xorg-libice-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add xorg-libice
# for installing globally
pixi global install xorg-libice
```
...
It is possible to list all of the versions of `xorg-libice` available on your platform:
...
```
pixi search xorg-libice --channel conda-forge
```
